...
def registration():
    return render_template('pages/register.html', title=WEBSITE_NAME, bg=bg_counter(), page='login')
...
def login():
    ...
    if form.validate_on_submit():
        flash('Login requested Username="' + form.input_username.data + '", Password=' + str(form.input_password.data))
        return redirect('/')
